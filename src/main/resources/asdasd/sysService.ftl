...
import com.heyi.jinbeijie.platform.sysuser.SysUser;
...
* @return
*/
public ${modelNameUpperCamel} add(${modelNameUpperCamel} ${modelNameLowerCamel}, SysUser currentUsers)  {
${modelNameLowerCamel}.set${getkey}(ID16NumberGenerator.get16NumberID());
${modelNameLowerCamel}.setCreator(currentUsers.getSysUserId());
...
* @
*/
public  ${modelNameUpperCamel} update(${modelNameUpperCamel} ${modelNameLowerCamel}, SysUser currentUsers) throws Exception  {
${modelNameUpperCamel} old${modelNameLowerCamel} = dao.getById(${modelNameLowerCamel}.get${getkey}());
${modelNameLowerCamel}.setModifyor(currentUsers.getSysUserId());
